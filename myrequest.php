    ...
    <div class="w3l-index-block4 pb-5">
        <div class="features-bg pb-lg-5 pt-lg-4 py-4">
            ...
            <br><br><br>
                ...
                <?php
            $cidv=$_SESSION['uid'];
        $qry = "SELECT `addads`.*,`addrequest`.*,`category`.* FROM `addads`,`addrequest`,`category` WHERE `addads`.`cid`=`category`.`cid` AND `addrequest`.`anid`=`addads`.`anid` AND `addrequest`.`uid`='$cidv'";
